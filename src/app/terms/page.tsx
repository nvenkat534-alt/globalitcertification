        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200">
          ...
          <div className="space-y-8 text-slate-600 font-sans leading-relaxed">
            <section>
              ...
              <p>
                Welcome to Global IT Certifications. By accessing our website and using our services, you agree to comply with and be bound by the following terms and conditions. If you disagree with any part of these terms, please do not use our website.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">2. Exam Vouchers</h2>
              <p>
                All certification exam vouchers purchased through Global IT Certifications are subject to the policies of the respective vendors (AWS, Microsoft, Salesforce, etc.). Vouchers are non-transferable and non-refundable once issued. The validity period of each voucher is set by the vendor and cannot be extended by us.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">3. Personalized Training</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-brand-dark mb-4">4. Payment Terms</h2>
              <p>
