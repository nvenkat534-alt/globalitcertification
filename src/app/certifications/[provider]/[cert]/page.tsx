        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pointer-events-none mb-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4 pointer-events-auto">
              <a href="https://wa.me/919205531284" className="bg-[#25D366] text-white px-8 py-4 rounded-xl font-bold font-sans hover:bg-green-600 transition shadow-lg shadow-green-900/20 flex items-center">
        ...
        {details ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl font-bold text-brand-dark mb-6 font-heading">Curriculum</h2>
                <div className="space-y-4">
                  {details.curriculum.map((item: any, i: number) => (
                    <div key={i} className="flex items-start space-x-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl">
                <h3 className="text-2xl font-bold text-brand-dark mb-6 font-heading border-b pb-4">Exam Details</h3>
                <ul className="space-y-6">
                  <li className="flex items-start space-x-4">
                    <Clock className="text-brand-blue mt-1" size={24} />
                    <div>
                      <span className="block font-bold text-brand-dark">Duration</span>
                      <span className="text-slate-600">{details.examDetails.duration}</span>
                    </div>
                  </li>
                  <li className="flex items-start space-x-4">
                    <FileText className="text-brand-blue mt-1" size={24} />
                    <div>
                      <span className="block font-bold text-brand-dark">Format</span>
                      <span className="text-slate-600">{details.examDetails.format}</span>
                    </div>
                  </li>
                  <li className="flex items-start space-x-4">
                    <DollarSign className="text-brand-blue mt-1" size={24} />
                    <div>
                      <span className="block font-bold text-brand-dark">Cost</span>
                      <span className="text-slate-600">{details.examDetails.cost}</span>
                    </div>
                  </li>
                </ul>
              </div>

              <div className="bg-brand-dark p-8 rounded-3xl text-white shadow-xl">
                ...
                <a href="https://wa.me/919205531284" className="mt-8 inline-block w-full text-center bg-brand-blue text-white px-8 py-4 rounded-xl font-bold hover:bg-brand-sky transition">
          ...
          <div className="bg-white p-12 rounded-3xl border border-slate-200 shadow-xl text-center">
            <h2 className="text-3xl font-bold text-brand-dark mb-4">Curriculum & Details</h2>
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto">This dedicated certification page is dynamic and will feature the complete syllabus, exam blueprint, and prerequisites for {displayName}.</p>
            <a href="https://wa.me/919205531284" className="inline-block bg-brand-dark text-white px-8 py-4 rounded-xl font-bold hover:bg-brand-blue transition">
              Request Full Syllabus
            </a>
          </div>
        )}
