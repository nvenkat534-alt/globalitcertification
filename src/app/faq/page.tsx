      ...
      <section className="py-20 bg-bg-dark relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/919392828155?text=Hi%20Global%20Certs%20IT%21%20I%20am%20interested%20in%20a%20global%20certification.%20Please%20share%20the%20price%20and%20payment%20details." className="bg-brand-blue text-white px-8 py-4 rounded-full font-bold hover:bg-brand-sky transition shadow-[0_0_30px_rgba(0,0,0,0.7)] shadow-brand-blue/30 flex items-center justify-center">
