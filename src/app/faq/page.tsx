      ...
      <section className="py-20 bg-bg-dark relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/9392828155?text=Hello!%20Can%20i%20get%20more%20info%20on%20this%20global%20certifications%20%3F" className="bg-brand-blue text-white px-8 py-4 rounded-full font-bold hover:bg-brand-sky transition shadow-[0_0_30px_rgba(0,0,0,0.7)] shadow-brand-blue/30 flex items-center justify-center">
