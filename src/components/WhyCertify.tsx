...
const WhyCertify = () => {
  return (
    <section className="bg-slate-50 py-16 md:py-20 text-slate-900 relative overflow-hidden border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-10 md:mb-14">
          ...
          <h2 className="text-4xl md:text-6xl font-bold font-heading text-brand-dark leading-[0.95] tracking-tight max-w-4xl">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14 items-start">
          <div className="lg:pt-8">
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-sans max-w-xl">
          ...
          <div className="flex flex-col gap-8 md:gap-10">
            {[
              ...
              <motion.div
                ...
                className="group flex gap-5 md:gap-8 items-center border-b border-slate-200 pb-8 md:pb-10 last:border-b-0 last:pb-0"
              >
                ...
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold mb-3 font-heading text-brand-dark group-hover:text-brand-blue transition-colors duration-300">
                    {item.title}
                  </h3>
                  <p className="text-slate-600 text-[15px] md:text-base leading-relaxed">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
