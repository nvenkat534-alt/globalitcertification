      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold font-heading text-white mb-4">Your Learning. Your Pace. <span className="text-brand-sky">Your Success.</span></h2>
            <p className="text-lg text-slate-400 max-w-3xl mx-auto">Unlike traditional classroom training, learners receive personalized attention based on their knowledge level and learning requirements.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-bg-dark p-8 rounded-2xl border border-slate-800/50 hover:shadow-[0_0_30px_rgba(0,0,0,0.7)] hover:border-brand-blue/20 transition-all group"
              >
        ...
        <div className="bg-bg-dark rounded-3xl p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="relative">
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-bg-dark/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl"
              >
                <div className="flex items-center justify-center w-16 h-16 bg-brand-sky text-white rounded-full mb-6">
                  <Trophy size={32} />
                </div>
