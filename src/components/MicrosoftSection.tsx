      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-brand-blue/5 rounded-3xl p-8 md:p-12 border border-brand-blue/20 flex flex-col md:flex-row items-center relative overflow-hidden">
          ...
          <div className="md:w-2/3 pr-0 md:pr-12 mb-8 md:mb-0 relative z-10">
            ...
            <a href="https://wa.me/919392828155?text=Hi%20Global%20Certs%20IT%21%20I%20am%20interested%20in%20a%20global%20certification.%20Please%20share%20the%20price%20and%20payment%20details." className="inline-flex bg-brand-blue text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-blue-700 transition items-center font-heading">
