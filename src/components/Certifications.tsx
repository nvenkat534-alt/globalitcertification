...
const Certifications = () => {
  const certs = [
    { name: 'AWS', iconUrl: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/amazonaws.svg', link: '/certifications/aws', isInternal: true },
    { name: 'Microsoft Azure', iconUrl: 'https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/microsoftazure.svg', link: '/certifications/microsoft', isInternal: true },
  ...
  return (
    <section id="certifications" className="pt-16 pb-16 bg-white relative z-10">
          ...
          {certs.map((cert, index) => {
            ...
            return (
              <FadeIn key={index} delay={(index % 4) * 100}>
                {cert.isInternal ? (
                  <Link href={cert.link} className={classes}>
                    {content}
                  </Link>
                ) : (
