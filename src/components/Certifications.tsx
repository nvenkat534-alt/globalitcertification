          ...
          {topCerts.map((cert, index) => (
            <FadeIn key={index} delay={(index % 5) * 50}>
              <Link href={cert.link} className="group flex flex-col items-center text-center transition-transform duration-300 hover:-translate-y-1">
                <div className="w-20 sm:w-24 h-20 sm:h-24 rounded-xl sm:rounded-2xl bg-white shadow-[0_0_25px_rgba(16,24,40,0.18)] border border-slate-200/80 flex items-center justify-center mb-2 sm:mb-4 transition-all duration-300 group-hover:shadow-[0_0_30px_rgba(91,108,255,0.25)] group-hover:border-[#5b6cff]/40">
                  {cert.iconUrl ? (
                    ...
                    <i className={`${cert.icon} text-lg sm:text-2xl text-[#5b6cff]`}></i>
                  )}
                </div>
                <h3 className="text-[12px] sm:text-[15px] font-bold text-white font-heading group-hover:text-[#5b6cff] transition-colors line-clamp-2 px-0.5">{cert.name}</h3>
              </Link>
            </FadeIn>
          ))}
          <FadeIn delay={450}>
            <Link href="/certifications" className="group flex flex-col items-center text-center transition-transform duration-300 hover:-translate-y-1">
              <div className="w-20 sm:w-24 h-20 sm:h-24 rounded-xl sm:rounded-2xl bg-white shadow-[0_0_25px_rgba(16,24,40,0.18)] border border-slate-200/80 flex items-center justify-center mb-2 sm:mb-4 transition-all duration-300 group-hover:shadow-[0_0_30px_rgba(91,108,255,0.25)] group-hover:border-[#5b6cff]/40">
                <i className="fas fa-arrow-right text-lg sm:text-2xl text-[#5b6cff]"></i>
              </div>
              <h3 className="text-[12px] sm:text-[15px] font-bold text-white font-heading group-hover:text-[#5b6cff] transition-colors">More</h3>
            </Link>
          </FadeIn>
        </div>
      </div>
