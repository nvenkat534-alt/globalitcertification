...
const Training = () => {
  return (
    <section id="training" className="py-24 bg-slate-50 border-y border-slate-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-brand-dark mb-6 leading-tight font-heading">
              Certification Training Designed to <span className="text-gradient">Help You Pass</span>
            </h2>
            
            <p className="text-slate-600 mb-8 text-lg font-sans leading-relaxed">
            ...
            <ul className="space-y-5 mb-10">
              <li className="flex items-start bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div>
                  <h4 className="font-bold font-heading text-brand-dark text-lg">Structured training</h4>
                  <p className="text-slate-500 font-sans text-sm mt-1">Perfectly aligned with official exam objectives.</p>
                </div>
              </li>
              <li className="flex items-start bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                <div className="bg-brand-blue/10 p-3 rounded-lg mr-4">
                ...
                <div>
                  <h4 className="font-bold font-heading text-brand-dark text-lg">Mock Exams & Practice</h4>
                  <p className="text-slate-500 font-sans text-sm mt-1">Simulate the real test experience to maximize your score.</p>
                </div>
              </li>
              <li className="flex items-start bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                <div className="bg-brand-blue/10 p-3 rounded-lg mr-4">
                ...
                <div>
                  <h4 className="font-bold font-heading text-brand-dark text-lg">Expert Guidance</h4>
                  <p className="text-slate-500 font-sans text-sm mt-1">Complete exam assistance and certification roadmap planning.</p>
                </div>
              </li>
            </ul>
            
            <a href="https://wa.me/919205531284" className="inline-flex items-center bg-brand-dark text-white px-8 py-4 rounded-xl font-bold font-heading text-lg hover:bg-brand-blue transition shadow-lg">
          ...
          >
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl z-20 border border-slate-200 flex items-center">
              ...
              <div>
                <p className="text-xs text-slate-500 font-sans font-bold uppercase tracking-wider">Success Rate</p>
                <p className="text-3xl font-bold font-heading text-brand-dark">98%</p>
              </div>
            </div>
          </motion.div>
        </div>
