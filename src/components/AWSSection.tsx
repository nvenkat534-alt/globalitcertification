    ...
    <section id="aws" className="py-20 bg-bg-dark border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          ...
          <a href="https://wa.me/919392828155?text=Hello!%20Can%20i%20get%20more%20info%20on%20this%20global%20certifications%20%3F" className="mt-6 md:mt-0 bg-bg-dark border border-brand-blue text-brand-blue px-6 py-3 rounded-xl font-bold hover:bg-brand-blue hover:text-white transition flex items-center font-heading">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-bg-dark rounded-3xl shadow-[0_0_15px_rgba(0,0,0,0.5)] border border-slate-800 overflow-hidden relative hover:shadow-[0_0_20px_rgba(0,0,0,0.6)] transition">
            ...
            <div className="p-8">
              ...
              <a href="https://wa.me/919392828155?text=Hello!%20Can%20i%20get%20more%20info%20on%20this%20global%20certifications%20%3F" className="block w-full text-center bg-brand-blue/5 hover:bg-brand-blue hover:text-white text-brand-blue border border-brand-blue/20 font-bold py-3 rounded-xl transition mt-8 font-heading">
                Get This Voucher
              </a>
            </div>
          </div>
          ...
          <div className="bg-bg-dark rounded-3xl shadow-[0_0_30px_rgba(0,0,0,0.7)] border-2 border-brand-blue overflow-hidden relative transform md:-translate-y-4">
            ...
            <div className="p-8">
              ...
              <a href="https://wa.me/919392828155?text=Hello!%20Can%20i%20get%20more%20info%20on%20this%20global%20certifications%20%3F" className="block w-full text-center bg-brand-blue text-white font-bold py-4 rounded-xl hover:bg-blue-700 transition mt-8 font-heading">
                Get This Voucher
              </a>
            </div>
          </div>
