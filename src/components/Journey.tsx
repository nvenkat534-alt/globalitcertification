...
const Journey = () => {
  ...
  return (
    <section className="py-24 bg-slate-50 relative z-20 border-y border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold font-heading text-brand-dark mb-4">Your Journey to Certification</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">A simple step-by-step process designed to take you from a beginner to a certified professional.</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
            {steps.map((step, i) => (
              ...
              >
                <div className="w-20 h-20 bg-white border-4 border-slate-100 rounded-full flex items-center justify-center text-brand-blue mb-6 shadow-md group-hover:border-brand-blue group-hover:scale-110 transition-all duration-300">
                  {step.icon}
                </div>
                <div className="bg-brand-blue/10 text-brand-blue text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-wider">
                  Step {i + 1}
                </div>
                <h3 className="text-lg font-bold text-brand-dark mb-2 font-heading">{step.title}</h3>
